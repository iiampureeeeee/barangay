...
<div class="sidebar sidebar-style-2">			
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary" style="border-radius: 30px 1px;">
                ...
                <li class="nav-item <?= $current_page=='resident_certification.php' || $current_page=='generate_brgy_cert.php' || $current_page=='resident_indigency.php' || $current_page=='generate_indi_cert.php' ? 'active' : null ?>">
                    <a href="#certificate" data-toggle="collapse" class="collapsed" aria-expanded="false">
                        <i class="fa fa-certificate"></i>
                            <p>Certificates</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse <?= $current_page=='resident_certification.php' || $current_page=='generate_brgy_cert.php'  || $current_page=='resident_indigency.php' || $current_page=='generate_indi_cert.php' ? 'show' : null ?>" id="certificate">
