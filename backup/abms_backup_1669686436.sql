...
#
# Generated: Tuesday 29. November 2022
# Hostname: localhost
# Database: abms
# --------------------------------------------------------
...
CREATE TABLE `tbl_support` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `tbl_support_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tblpayments` (`id`)
...
INSERT INTO tblbrgy_info VALUES("1","Misamis Oriental","Cagayan de Oro City","BRGY. Bon-Bon","0919-1234567","Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Sed porttitor lectus nibh. Curabitur aliquet quam id dui posuere blandit.","09112022033726maxresdefault.jpg","09112022033726Cagayan_de_Oro_City_seal.png","09112022033726logo-brgy.png");
...
INSERT INTO tblpayments VALUES("11","Barangay Clearance Payment","100.00","2022-11-09","admin"," Ronil 213213 Cajan");
INSERT INTO tblpayments VALUES("12","Certificate of Indigency Payment","100.00","2022-11-09","admin"," Ronil 213213 Cajan");
INSERT INTO tblpayments VALUES("13","Barangay Clearance Payment","100.00","2022-11-28","admin"," Ronil 213213 Cajan");
INSERT INTO tblpayments VALUES("14","Certificate of Indigency Payment","100.00","2022-11-28","admin"," Ronil 213213 Cajan");
