					...
					<div class="row">
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#AF7AB3,#E4D192);
									...
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center" style="color:white; text-shadow: 2px 2px 5px #354259;">
												<i class="flaticon-users" href="resident_info.php?state=all"></i>
											</div>
										</div>
								...
								<div class="card-body">
									<a href="resident_info.php?state=all" class="card-link text-light stretched-link">Total Population </a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#E9DAC1,#9ED2C6);
								...
								<div class="card-body">
									<a href="resident_info.php?state=male" class="card-link text-light stretched-link" style="text-shadow: 2px 2px 5px #665A48;">Total Male </a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#FFE3E1,#FF9494);
								...
								<div class="card-body">
									<a href="resident_info.php?state=female" class="card-link text-light stretched-link" style="text-shadow: 2px 2px 5px #354259;">Total Female </a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#789395,#B4CFB0);
								...
								<div class="card-body">
									<a href="resident_info.php?state=voters" class="card-link text-light stretched-link">Total Voters </a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#9AD0EC,#1572A1);
								...
								<div class="card-body">
									<a href="resident_info.php?state=non_voters" class="card-link text-light stretched-link">Total Non Voters </a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#E4D1B9,#BE8C63);
								...
								<div class="card-body">
									<a href="purok_info.php?state=precinct" class="card-link text-light stretched-link" style="color:white; text-shadow: 2px 2px 5px #354259;">Precint Information</a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#BF8B67,#632626);
								...
								<div class="card-body">
									<a href="purok_info.php?state=purok" class="card-link text-light stretched-link">Purok Information</a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							...
							style="background: linear-gradient(45deg,#B97A95,#716F81);
								...
								<div class="card-body">
									<a href="revenue.php" class="card-link text-light stretched-link" style="color:white; text-shadow: 2px 2px 5px #354259;">All Revenues</a>
								</div>
							</div>
						</div>
					</div>
